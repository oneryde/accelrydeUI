        ...
        <div className="relative group">
          <div className="opacity-40 grayscale transition-all group-hover:opacity-60 group-hover:grayscale-0">
            <svg
              ...
              role="img"
            >
              <rect width="120" height="40" rx="6" className="fill-card stroke-border" strokeWidth="0.5" />
          ...
          <span className="absolute -top-2 -right-2 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-accent text-white rounded-full">
            Soon
          </span>
        </div>
        ...
        <div className="relative group">
          <div className="opacity-40 grayscale transition-all group-hover:opacity-60 group-hover:grayscale-0">
            <svg
              ...
              role="img"
            >
              <rect width="135" height="40" rx="6" className="fill-card stroke-border" strokeWidth="0.5" />
